...
public class MyFoodTable {
	...
	public static final int FOOD_COL_FOODID = FOOD_COL_ID + 2;
	
	public static final String FOOD_KEY_PURCHASED = "purchaseDate";
	public static final int FOOD_COL_PURCHASED = FOOD_COL_ID + 3;
	
	public static final String FOOD_KEY_OPENED = "openDate";
	public static final int FOOD_COL_OPENED = FOOD_COL_ID + 4;
	
	public static final String FOOD_KEY_STATE = "state";
	public static final int FOOD_COL_STATE = FOOD_COL_ID + 5;
	
	public static final String FOOD_KEY_QUANTITY = "quantity";
	public static final int FOOD_COL_QUANTITY = FOOD_COL_ID + 6;
	
	public static final String FOOD_KEY_PICTURE = "picture";
	public static final int FOOD_COL_PICTURE = FOOD_COL_ID + 7;
	
	public static final String FOOD_KEY_NOTES = "notes";
	public static final int FOOD_COL_NOTES = FOOD_COL_ID + 8;
