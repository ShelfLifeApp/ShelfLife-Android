			...
			if(numExpiring > 0 && notificationsEnabled){
				...
				if(notificationRate == 7){
					ncb = new NotificationCompat.Builder(context)
				        ...
				        .setContentText(resources.getString(R.string.notification_text_7_days))
				        .setTicker(resources.getString(R.string.notification_ticker));
				}else if(notificationRate == 1){
					ncb = new NotificationCompat.Builder(context)
					.setSmallIcon(R.drawable.icon_notif)
			        .setContentTitle(resources.getString(R.string.notification_title))
			        .setContentText(resources.getString(R.string.notification_text_1_days))
			        .setTicker(resources.getString(R.string.notification_ticker));
				}else{
					ncb = new NotificationCompat.Builder(context)
					.setSmallIcon(R.drawable.icon_notif)
			        .setContentTitle(resources.getString(R.string.notification_title))
			        .setContentText(resources.getString(R.string.notification_text_0_days))
			        .setTicker(resources.getString(R.string.notification_ticker));
				}
